        ...
        {loading ? (
          ...
          <>
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-semibold text-gray-900">{avatarName || 'Sin nombre'}</p>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 space-y-4">
              <h2 className="font-semibold text-gray-900">Registrar peso</h2>
              ...
              <form onSubmit={handleAddStat} className="flex gap-2">
                ...
                <button
                  type="submit"
                  className="bg-gray-900 text-white rounded-lg px-4 py-2 text-sm font-semibold hover:bg-gray-800 transition-colors shrink-0"
                >
                  Añadir
                </button>
              </form>
              ...
              {bodyStats.length > 0 ? (
                <ul className="space-y-1">
                  {bodyStats.slice(0, 10).map((s) => (
                    <li key={s.id} className="flex justify-between text-sm text-gray-700 py-1 border-b border-gray-100 last:border-0">
                ...
                <p className="text-sm text-gray-400">No hay registros de peso todavía.</p>
              )}
            </div>
          </>
        )}
